         ...
         <table id="tab" style="text-align:left;">
            ...
            try{  
            	...
            	while(rs.next())  
            	{
            		...
            		<tr id="<%=id%>">
            		<td><input type="checkbox" name="id" value="<%=rs.getInt(26)%>" onChange="myFunction(<%=id%>,this)" id="messageCheckbox" class="messageCheckbox"></td>
                    <td><%=rs.getInt(20) %></td>
                    <td><%=rs.getInt(6)%></td>
                    <td><%=rs.getInt(5)%></td>
                    <td><%=rs.getFloat(4)%></td>
                    <td id="<%=id%>"><%=rs.getDate(22)%></td>
                    <td><%=rs.getDate(23)%></td>
...
<!-- Edit Invoice POP UP Box  -->
      ...
      <div class="edit_invoice" id="edit_popup">
        ...
        <div class="title">
          ...
          <!-- close button  -->
          <div>
            <img src="images/close.svg" alt="close" id="close_btn" onclick="closebox()">
          </div>
          </div>
          <!-- Invoice Amount div -->
          <div class="invoice_amount">
            ...
            <div>
              <input type="text"  id="inputtext" placeholder="$56354.52" name="invoice_amt" value="">
            </div>
        </div>
        <!-- Notes div  -->
        <div class="Notes">
          ...
          <div>
            <input type="text"  id="inputtext" placeholder="Enter Your Notes...." name="note" value="">
          </div>
        </div>
       <!-- Cancel Button,Reset btn and Save btn  -->
        <div class="footer_part"> 
          <div>
            <h2 onclick="closebox()">Cancel</h2>
          </div>
          <div>
            <button type="button" id="save_btn" onclick="savechanges">Save</button>
          </div>
          <div>
